...
export interface SentenceCreationAndGroupingResponse { 
    difficulty: number;
    id: number;
    lastModified: Date;
    owner: string;
    ...
    subject: SentenceCreationAndGroupingResponse.SubjectEnum;
    title: string;
    type: SentenceCreationAndGroupingResponse.TypeEnum;
}
export namespace SentenceCreationAndGroupingResponse {
