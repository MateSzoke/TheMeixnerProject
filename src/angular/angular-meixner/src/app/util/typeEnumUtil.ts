...
export class TypeEnumUtil {
  ...
  public static taskTypeToString(type: TypeEnum): string{
    switch(type){
      case "Pairing": return "Párosítás"
      case "Grouping": return "Csoportosítás"
      case "Sorting": return "Sorrendezés"
      case "SentenceCreation": return "Mondat készítés"
      case "SentenceCompletion": return "Mondat kiegészítés"
      case "TrueFalse": return "Igaz/Hamis"
      case "MemoryGame": return "Memóriajáték"
      case "GroupingAndSorting": return "Csoportosítás és sorrendezés"
      case "SentenceCreationAndSorting": return "Mondatkészítés és sorrendezés "
